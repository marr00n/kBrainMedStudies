...
- Site of action: NMJ  
  ...
  - ACh released from presynaptic vesicles  
  - Binds postsynaptic receptors → Na⁺ influx → depolarisation → contraction  
  - NMBAs block this final step  

### Neuromuscular transmission (summary)
...
- No effect on:
  ...
  - Consciousness  
  - Pain perception  
  - Haemodynamics (directly; varies by agent)
...
- Optimise surgical conditions (muscle relaxation)  

#### ICU / longer-term

- Ventilator synchrony (↓ patient–ventilator dyssynchrony)  
- Severe ARDS
  - ↓ chest wall tone → ↓ intrathoracic pressure → improved ventilation  

- Control of raised ICP  
- Facilitate accurate measurements of intra-abdominal pressure  
- Refractory shivering (e.g. therapeutic hypothermia)  
- Reduce O₂ consumption (↓ muscle activity)

> [!warning]
> Use only when necessary. Exhaust sedation, analgesia, and ventilator optimisation first.

### Practical considerations

- Provide deep sedation prior to paralysis  
- Monitor depth of block (e.g. peripheral nerve stimulator, TOF)  
- Ensure airway control and ventilatory support  
- Regular eye care (↓ blink reflex → corneal injury risk)

### Complications

- Awareness during paralysis (if inadequate sedation)  
- Prolonged weakness / ICU-acquired weakness  
